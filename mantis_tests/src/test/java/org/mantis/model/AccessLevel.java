...
public class AccessLevel {
  ...
  public AccessLevel id(@javax.annotation.Nullable Long id) {
    this.id = id;
    return this;
  }
  ...
  public AccessLevel name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AccessLevel label(@javax.annotation.Nullable String label) {
    this.label = label;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccessLevel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AccessLevel is not found in the empty JSON string", AccessLevel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccessLevel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AccessLevel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
